...
def test_equality_is_direct_calculated_far():
    numeric = load_numeric()
...
def test_nonanchor_equality_uses_event_calculated_far_then_nextafter_fits():
    numeric = load_numeric()
...
def test_pretail_sparse_support_is_direct_without_interpolation():
    numeric = load_numeric()
