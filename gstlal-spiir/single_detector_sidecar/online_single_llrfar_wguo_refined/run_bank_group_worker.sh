...
"${spiir_run_function}" \
    ...
    -e ONLINE_REPLAY_START_GPS="${ONLINE_REPLAY_START_GPS}" \
	    ...
	    -e CRASHCAR_SNR_SERIES_OUTPUT_DIR="${CRASHCAR_SNR_SERIES_OUTPUT_DIR:-crashcar_snr_series}" \
	    ...
	    -e CRASHCAR_FAR_FLOOR_COUNT="${CRASHCAR_FAR_FLOOR_COUNT:-1.0}" \
			    ...
			    -e CRASHCAR_REQUIRE_TEMPLATE_SHAPE_MAP="${CRASHCAR_REQUIRE_TEMPLATE_SHAPE_MAP:-${CRASHCAR_ENABLE:-0}}" \
