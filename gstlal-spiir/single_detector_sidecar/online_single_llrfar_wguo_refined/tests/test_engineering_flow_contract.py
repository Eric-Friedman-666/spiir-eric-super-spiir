...
class EngineeringFlowContractTests(unittest.TestCase):
    ...
    def test_crashcar_frozen_injection_workflow_uses_lower_data_contract(self) -> None:
        ...
        self.assertIn("BG_UPDATE_SECONDS=${injection_bg_BG_update_seconds", source)
        ...
        self.assertIn("INJ_BG_UPDATE_SECONDS=${injection_BG_update_seconds", source)
        self.assertIn("INJ_BG_UPDATE_HOUR=${injection_BG_update_hour", source)
