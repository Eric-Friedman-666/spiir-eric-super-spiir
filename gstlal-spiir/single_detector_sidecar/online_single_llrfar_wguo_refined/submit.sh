...

{
    for name in \
        ...
        SPIIR_BUILD_NAME SPIIR_HELPER_FUNCTIONS SPIIR_SOURCE_DIR PIPELINE_MODE SINGLE_INPUT_KIND \
        ...
        BANK_DIR BANK_DIR_SOURCE FALLBACK_BANK_DIR NONINJ_STATS_LOC DETRSP_MAP WGUO_BANK_STATS_DIR \
