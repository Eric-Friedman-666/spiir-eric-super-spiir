...
BATCH_SUBMIT_CONFIG
  ...
  FINAL_SINGLE_INPUT_KIND=${FINAL_SINGLE_INPUT_KIND:-zerolag}
  FINAL_SINGLE_RESET_LEDGER=${FINAL_SINGLE_RESET_LEDGER:-0}
  FINAL_SINGLE_IGNORE_ONLINE_REPLAY_GATE=${FINAL_SINGLE_IGNORE_ONLINE_REPLAY_GATE:-1}
  SINGLE_TRIGGER_STREAM_ENABLE=${SINGLE_TRIGGER_STREAM_ENABLE:-1}
  SINGLE_TRIGGER_STREAM_FILE=${SINGLE_TRIGGER_STREAM_FILE:-}
  SIDECAR_PRESERVE_TABLE_SINGLE_FAR=${SIDECAR_PRESERVE_TABLE_SINGLE_FAR:-1}
  SIDECAR_SINGLE_FAR_LEDGER=${SIDECAR_SINGLE_FAR_LEDGER:-}
  SIDECAR_SINGLE_FAR_LOOKUP_INTERVAL_SECONDS=${SIDECAR_SINGLE_FAR_LOOKUP_INTERVAL_SECONDS:-1.0}
  SIDECAR_PATCH_ZEROLAG_SINGLE_FAR=${SIDECAR_PATCH_ZEROLAG_SINGLE_FAR:-1}
  PATCH_ZEROLAG_SINGLE_FAR=${PATCH_ZEROLAG_SINGLE_FAR:-${SIDECAR_PATCH_ZEROLAG_SINGLE_FAR:-1}}
  PATCH_ZEROLAG_SINGLE_FAR_LEDGER=${PATCH_ZEROLAG_SINGLE_FAR_LEDGER:-single_branch/single_final_far_all.csv}
  PATCH_ZEROLAG_SINGLE_FAR_COLUMN=${PATCH_ZEROLAG_SINGLE_FAR_COLUMN:-direct_far}
  SINGLE_OUTPUT_MODE=${SINGLE_OUTPUT_MODE:-single-only}
  SINGLE_OUTPUT_ACTIVE_IFO_SCHEDULE=${SINGLE_OUTPUT_ACTIVE_IFO_SCHEDULE:-}
  PATCH_ZEROLAG_SINGLE_OUTPUT_MODE=${PATCH_ZEROLAG_SINGLE_OUTPUT_MODE:-${SINGLE_OUTPUT_MODE}}
  PATCH_ZEROLAG_SINGLE_OUTPUT_ACTIVE_IFO_SCHEDULE=${PATCH_ZEROLAG_SINGLE_OUTPUT_ACTIVE_IFO_SCHEDULE:-${SINGLE_OUTPUT_ACTIVE_IFO_SCHEDULE}}
  PREFER_FEATURE_SINGLE_FAR=${PREFER_FEATURE_SINGLE_FAR:-0}
  ...
  CRASHCAR_SNR_SERIES_OUTPUT_DIR=${CRASHCAR_SNR_SERIES_OUTPUT_DIR:-crashcar_snr_series}
  ...
  CRASHCAR_REQUIRE_TEMPLATE_SHAPE_MAP=${CRASHCAR_REQUIRE_TEMPLATE_SHAPE_MAP:-${CRASHCAR_ENABLE:-0}}
