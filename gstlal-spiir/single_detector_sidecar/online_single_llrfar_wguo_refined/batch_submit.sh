...
if [ "${CRASHCAR_ENABLE:-0}" = "1" ] && [ -z "${CRASHCAR_TEMPLATE_SHAPE_MAP_FNAME:-}" ]; then
...
BATCH_SUBMIT_CONFIG
  ...
  CRASHCAR_ENABLE=${CRASHCAR_ENABLE:-0}
  CRASHCAR_DETAIL_OUTPUT_FNAME=${CRASHCAR_DETAIL_OUTPUT_FNAME:-}
  CRASHCAR_LOG10_FAR_THRESHOLD=${CRASHCAR_LOG10_FAR_THRESHOLD:--4.0}
  CRASHCAR_MIN_SNR=${CRASHCAR_MIN_SNR:-4.0}
  CRASHCAR_FAR_FLOOR_COUNT=${CRASHCAR_FAR_FLOOR_COUNT:-1.0}
  CRASHCAR_LIVETIME_STEP=${CRASHCAR_LIVETIME_STEP:-1.0}
  CRASHCAR_BACKGROUND_REQUIRED_SECONDS=${CRASHCAR_BACKGROUND_REQUIRED_SECONDS:-}
  CRASHCAR_EXPECTED_BUFFERS_PER_TIMESTAMP=${CRASHCAR_EXPECTED_BUFFERS_PER_TIMESTAMP:-}
  CRASHCAR_TEMPLATE_SHAPE_MAP_FNAME=${CRASHCAR_TEMPLATE_SHAPE_MAP_FNAME:-}
  CRASHCAR_SUPPORT_DEBUG=${CRASHCAR_SUPPORT_DEBUG:-0}
  CRASHCAR_SUPPORT_DEBUG_FNAME=${CRASHCAR_SUPPORT_DEBUG_FNAME:-}
  CRASHCAR_CLUSTER_DEBUG=${CRASHCAR_CLUSTER_DEBUG:-0}
  CRASHCAR_CLUSTER_DEBUG_FNAME=${CRASHCAR_CLUSTER_DEBUG_FNAME:-}
