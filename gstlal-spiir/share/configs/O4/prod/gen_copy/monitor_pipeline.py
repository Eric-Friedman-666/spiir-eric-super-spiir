...
postcoh = Table(
    ...
    Column('end_time_ns_sngl_V1', Integer),
    Column('end_time_sngl_H1', Integer), Column('end_time_sngl_K1', Integer),
    Column('end_time_sngl_L1', Integer), Column('end_time_sngl_V1', Integer),
    Column('eta', Double), Column('event_id', BigInteger),
    Column('f_final', Double), Column('fap', Double), Column('far', Double),
    Column('far_1d', Double), Column('far_1d_sngl_H1', Double),
    Column('far_1d_sngl_K1', Double), Column('far_1d_sngl_L1', Double),
    Column('far_1d_sngl_V1', Double), Column('far_1w', Double),
    Column('far_1w_sngl_H1', Double), Column('far_1w_sngl_K1', Double),
    Column('far_1w_sngl_L1', Double), Column('far_1w_sngl_V1', Double),
    Column('far_2h', Double), Column('far_2h_sngl_H1', Double),
    Column('far_2h_sngl_K1', Double), Column('far_2h_sngl_L1', Double),
    Column('far_2h_sngl_V1', Double), Column('far_sngl_H1', Double),
    Column('far_sngl_K1', Double), Column('far_sngl_L1', Double),
    Column('far_sngl_V1', Double), Column('ifos', String),
    Column('is_background', Integer), Column('livetime', Integer),
