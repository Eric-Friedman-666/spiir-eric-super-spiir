...
from spiir.io.igwn.alert.consumers.sealgw import SealGWAlertConsumer
from sealgw.seal import Seal
...
def parse_cli_arguments() -> argparse.Namespace:
    ...
    parser.add_argument("seal_config", help="Path to SealGW config file.")
    parser.add_argument(
        "--out",
        type=str,
        default="./results/",
