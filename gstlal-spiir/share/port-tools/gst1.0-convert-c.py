...
# Copied from https://git.ligo.org/lscsoft/gstlal/-/blob/master/gstlal/port-tools/gst1.0-convert-c.py
...
with open(sys.argv[1]) as f:
    for line in f:
        ...
        (mod_line, mod_num) = re.subn(r'audio/x-raw-float', r'audio/x-raw',
                                      line)
        if mod_num != 0:
        ...
        (mod_line, mod_num) = re.subn(r'text/plain',
                                      r'text/x-raw, format=utf8', line)
        if mod_num != 0:
        ...
        (mod_line, mod_num) = re.subn(r'gst_object_sink',
                                      r'gst_object_ref_sink', line)
        if mod_num != 0:
        ...
        (mod_line, mod_num) = re.subn(r'gst_element_class_set_details_simple',
                                      r'gst_element_class_set_metadata', line)
        if mod_num != 0:
            line = mod_line
        ...
        (mod_line,
         mod_num) = re.subn(r'gst_element_class_set_documentation_uri',
                            r'gst_element_class_add_metadata', line)
        if mod_num != 0:
        ...
        (mod_line, mod_num) = re.subn(r'gst_element_factory_get_longname',
                                      r'gst_element_factory_get_metadata',
                                      line)
        if mod_num != 0:
        ...
        (mod_line, mod_num) = re.subn(r'gst_element_factory_get_klass',
                                      r'gst_element_factory_get_metadata',
                                      line)
        if mod_num != 0:
        ...
        (mod_line, mod_num) = re.subn(r'gst_element_factory_get_description',
                                      r'gst_element_factory_get_metadata',
                                      line)
        if mod_num != 0:
        ...
        (mod_line, mod_num) = re.subn(r'gst_element_factory_get_author',
                                      r'gst_element_factory_get_metadata',
                                      line)
        if mod_num != 0:
        ...
        (mod_line,
         mod_num) = re.subn(r'gst_element_factory_get_documentation_uri',
                            r'gst_element_factory_get_metadata', line)
        if mod_num != 0:
        ...
        (mod_line, mod_num) = re.subn(r'gst_element_factory_get_icon_name',
                                      r'gst_element_factory_get_metadata',
                                      line)
        if mod_num != 0:
        ...
        (mod_line, mod_num) = re.subn(
            r'gst_element_factory_can_(.+)_caps',
            r'gst_element_factory_can_\1_{CHOOSE:any,all}_caps', line)
        if mod_num != 0:
        ...
        (mod_line,
         mod_num) = re.subn(r'gst_element_class_add_static_pad_template',
                            r'gst_element_class_add_pad_template', line)
        if mod_num != 0:
            line = mod_line
            modded = True
        ...
        (mod_line, mod_num) = re.subn(r'gst_element_lost_state_full',
                                      r'gst_element_lost_state', line)
        if mod_num != 0:
        ...
        (mod_line, mod_num) = re.subn(r'gst_element_lost_state\((.+)\)',
                                      r'gst_element_lost_state(\1, TRUE)',
                                      line)
        if mod_num != 0:
...
# push the tag event.
        ...
        (mod_line, mod_num) = re.subn(r'request_new_pad_full',
                                      r'request_new_pad', line)
        if mod_num != 0:
...
# that can be used to allocate buffers using gst_buffer_pool_acquire_buffer().
        m = re.search(
            '(gst_pad_set_bufferalloc_function|gst_pad_alloc_buffer|gst_pad_alloc_buffer_and_set_caps)',
            line)
        if m != None:
...
# value needs to be unreffed after usage.
        m = re.search(
            '(gst_pad_get_pad_template_caps|gst_pad_get_pad_template)', line)
        if m != None:
...
# general dangerous and can be implemented using the callbacks if needed.
        m = re.search(
            '(gst_pad_set_blocked|gst_pad_set_blocked_async|gst_pad_set_blocked_async_full|gst_pad_add_probe)',
            line)
        if m != None:
...
# gst_pad_remove_probe() for equivalent functionality.
        m = re.search(
            '(gst_pad_add_data_probe|gst_pad_add_data_probe_full|gst_pad_remove_data_probe|gst_pad_add_event_probe|gst_pad_add_event_probe_full|gst_pad_remove_event_probe|gst_pad_add_buffer_probe|gst_pad_add_buffer_probe_full|gst_pad_remove_buffer_probe)',
            line)
        if m != None:
...
# gst_pad_get_negotiated_caps() -> gst_pad_get_current_caps()
        (mod_line, mod_num) = re.subn(r'gst_pad_get_negotiated_caps',
                                      r'gst_pad_get_current_caps', line)
        if mod_num != 0:
...
# GST_FLOW_UNEXPECTED -> GST_FLOW_EOS
        (mod_line, mod_num) = re.subn(r'GST_FLOW_UNEXPECTED', r'GST_FLOW_EOS',
                                      line)
        if mod_num != 0:
...
# GST_FLOW_WRONG_STATE -> GST_FLOW_FLUSHING
        (mod_line, mod_num) = re.subn(r'GST_FLOW_WRONG_STATE',
                                      r'GST_FLOW_FLUSHING', line)
        if mod_num != 0:
...
# GstActivateMode -> GstPadMode
        ...
        (mod_line, mod_num) = re.subn(r'GST_ACTIVATE_(.+)', r'GST_PAD_MODE_\1',
                                      line)
        if mod_num != 0:
...
# gst_pad_activate_{pull,push}() -> gst_pad_activate_mode()
        (mod_line, mod_num) = re.subn(r'gst_pad_activate_push',
                                      r'gst_pad_activate_mode', line)
        if mod_num != 0:
            mod_str = ' /* MOD: gst_pad_activate_{pull,push}() -> gst_pad_activate_mode() */'
            line = mod_line
            modded = True
        (mod_line, mod_num) = re.subn(r'gst_pad_activate_pull',
                                      r'gst_pad_activate_mode', line)
        if mod_num != 0:
            mod_str = ' /* MOD: gst_pad_activate_{pull,push}() -> gst_pad_activate_mode() */'
            line = mod_line
...
# gst_pad_proxy_getcaps() -> gst_pad_proxy_query_caps()
        (mod_line, mod_num) = re.subn(r'gst_pad_proxy_getcaps',
                                      r'gst_pad_proxy_query_caps', line)
        if mod_num != 0:
...
# gst_pad_get_caps() -> gst_pad_query_caps()
        (mod_line, mod_num) = re.subn(r'gst_pad_get_caps',
                                      r'gst_pad_query_caps', line)
        if mod_num != 0:
...
# gst_pad_peer_get_caps() -> gst_pad_peer_query_caps()
        (mod_line, mod_num) = re.subn(r'gst_pad_peer_get_caps',
                                      r'gst_pad_peer_query_caps', line)
        if mod_num != 0:
        ...
        (mod_line, mod_num) = re.subn(r'gst_pad_accept_caps',
                                      r'gst_pad_query_accept_caps', line)
        if mod_num != 0:
        ...
        (mod_line, mod_num) = re.subn(r'gst_pad_peer_accept_caps',
                                      r'gst_pad_peer_query_accept_caps', line)
        if mod_num != 0:
        ...
        (mod_line, mod_num) = re.subn(r'gst_pad_query_peer_(.+)',
                                      r'gst_pad_peer_query_\1', line)
        if mod_num != 0:
...
# GstPadFlags: GST_PAD_* -> GST_PAD_FLAG_*
        (mod_line, mod_num) = re.subn(r'GST_PAD_(.+)', r'GST_PAD_FLAG_\1',
                                      line)
        if mod_num != 0:
...
# gst_param_spec_mini_object() -> g_param_spec_boxed()
        (mod_line, mod_num) = re.subn(r'gst_param_spec_mini_object',
                                      r'g_param_spec_boxed', line)
        if mod_num != 0:
            line = mod_line
...
# gst_value_set_mini_object() -> g_value_set_boxed()
        (mod_line, mod_num) = re.subn(r'gst_value_set_mini_object',
                                      r'g_value_set_boxed', line)
        if mod_num != 0:
            line = mod_line
...
# gst_value_take_mini_object() -> g_value_take_boxed()
        (mod_line, mod_num) = re.subn(r'gst_value_take_mini_object',
                                      r'g_value_take_boxed', line)
        if mod_num != 0:
...
# gst_value_take_get_object() -> g_value_get_boxed()
        (mod_line, mod_num) = re.subn(r'gst_value_take_get_object',
                                      r'g_value_get_boxed', line)
        if mod_num != 0:
...
# gst_value_take_dup_object() -> g_value_dup_boxed()
        (mod_line, mod_num) = re.subn(r'gst_value_take_dup_object',
                                      r'g_value_dup_boxed', line)
        if mod_num != 0:
...
# GST_BUFFER_SIZE() are gone, along with the fields in GstBuffer.
        m = re.search(
            '(GST_BUFFER_DATA|GST_BUFFER_MALLOCDATA|GST_BUFFER_FREE_FUNC|GST_BUFFER_SIZE)',
            line)
        if m != None:
...
# with gst_buffer_make_writable().
        (mod_line, mod_num) = re.subn(r'gst_buffer_make_metadata_writable',
                                      r'gst_buffer_make_writable', line)
        if mod_num != 0:
...
# gst_buffer_copy_region().
        (mod_line, mod_num) = re.subn(r'gst_buffer_create_sub',
                                      r'gst_buffer_copy_region', line)
        if mod_num != 0:
...
# which now returns NULL when memory allocation fails.
        (mod_line, mod_num) = re.subn(r'gst_buffer_try_new_and_alloc',
                                      r'gst_buffer_new_and_alloc', line)
        if mod_num != 0:
...
# gst_buffer_list_sized_new() -> gst_buffer_list_new_sized()
        (mod_line, mod_num) = re.subn(r'gst_buffer_list_sized_new',
                                      r'gst_buffer_list_new_sized', line)
        if mod_num != 0:
            line = mod_line
...
# gst_buffer_list_len() -> gst_buffer_list_length()
        (mod_line, mod_num) = re.subn(r'gst_buffer_list_len',
                                      r'gst_buffer_list_length', line)
        if mod_num != 0:
            line = mod_line
...
# gst_structure_empty_new() -> gst_structure_new_empty()
        (mod_line, mod_num) = re.subn(r'gst_structure_empty_new',
                                      r'gst_structure_new_empty', line)
        if mod_num != 0:
            line = mod_line
...
# gst_structure_id_empty_new() -> gst_structure_new_id_empty()
        (mod_line, mod_num) = re.subn(r'gst_structure_id_empty_new',
                                      r'gst_structure_new_id_empty', line)
        if mod_num != 0:
            line = mod_line
        ...
        (mod_line, mod_num) = re.subn(r'gst_structure_id_new',
                                      r'gst_structure_new_id', line)
        if mod_num != 0:
            line = mod_line
...
# gst_event_new_qos_full() -> gst_event_new_qos()
        (mod_line, mod_num) = re.subn(r'gst_event_new_qos_full',
                                      r'gst_event_new_qos', line)
        if mod_num != 0:
            line = mod_line
...
# gst_event_parse_qos_full() -> gst_event_parse_qos()
        (mod_line, mod_num) = re.subn(r'gst_event_parse_qos_full',
                                      r'gst_event_parse_qos', line)
        if mod_num != 0:
            line = mod_line
...
# GST_EVENT_NEWSEGMENT -> GST_EVENT_SEGMENT
        (mod_line, mod_num) = re.subn(r'GST_EVENT_NEWSEGMENT',
                                      r'GST_EVENT_SEGMENT', line)
        if mod_num != 0:
            line = mod_line
...
# gst_query_new_application() -> gst_query_new_custom()
        (mod_line, mod_num) = re.subn(r'gst_query_new_application',
                                      r'gst_query_new_custom', line)
        if mod_num != 0:
...
# gst_query_parse_formats_length() -> gst_query_parse_n_formats()
        (mod_line, mod_num) = re.subn(r'gst_query_parse_formats_length',
                                      r'gst_query_parse_n_formats', line)
        if mod_num != 0:
        ...
        (mod_line, mod_num) = re.subn(r'gst_query_parse_formats_nth',
                                      r'gst_query_parse_nth_format', line)
        if mod_num != 0:
...
#   - gst_element_query_convert()
        m = re.search(
            '(gst_pad_query_position|gst_pad_query_duration|gst_pad_query_convert|gst_pad_query_peer_position|gst_pad_query_peer_duration|gst_pad_query_peer_convert|gst_element_query_position|gst_element_query_duration|gst_element_query_convert)',
            line)
        if m != None:
...
# functions were removed.
        m = re.search('(gst_element_get_query_types|gst_pad_get_query_types)',
                      line)
        if m != None:
...
# GST_MESSAGE_DURATION -> GST_MESSAGE_DURATION_CHANGED
        (mod_line, mod_num) = re.subn(r'GST_MESSAGE_DURATION',
                                      r'GST_MESSAGE_DURATION_CHANGED', line)
        if mod_num != 0:
            line = mod_line
...
# GST_VIDEO_CAPS_xxx -> GST_VIDEO_CAPS_MAKE(xxx)
        (mod_line, mod_num) = re.subn(r'GST_VIDEO_CAPS_(.+)',
                                      r'GST_VIDEO_CAPS_MAKE(\1)', line)
        if mod_num != 0:
            line = mod_line
...
# which may help find the places that need to be updated.
        m = re.search(
            '(gst_caps_normalize|gst_caps_do_simplify|gst_caps_merge|gst_caps_merge_structure|gst_caps_truncate)',
            line)
        if m != None:
...
# the old gst_clock_id_wait_async() function was removed.
        (mod_line, mod_num) = re.subn(r'gst_clock_id_wait_async_full',
                                      r'gst_clock_id_wait_async', line)
        if mod_num != 0:
            line = mod_line
...
# simply modify the structure members duration and position respectively.
        m = re.search('(gst_segment_set_duration|gst_segment_set_last_stop)',
                      line)
        if m != None:
...
# with seek parameters.
        ...
        (mod_line, mod_num) = re.subn(r'GST_PLUGIN_FEATURE_NAME',
                                      r'GST_OBJECT_NAME', line)
        if mod_num != 0:
            line = mod_line
        ...
        (mod_line, mod_num) = re.subn(r'gst_task_create', r'gst_task_new',
                                      line)
        if mod_num != 0:
            line = mod_line
...
#     ...
        (mod_line, mod_num) = re.subn(r'GstBaseAudio(.+)', r'GstAudioBase\1',
                                      line)
        if mod_num != 0:
            line = mod_line
...
# gst_tag_list_new() has been renamed to gst_tag_list_new_empty().
        (mod_line, mod_num) = re.subn(r'gst_tag_list_new',
                                      r'gst_tag_list_new_empty', line)
        if mod_num != 0:
            line = mod_line
...
# gst_tag_list_new_full*() have been renamed to gst_tag_list_new*().
        (mod_line, mod_num) = re.subn(r'gst_tag_list_new_full',
                                      r'gst_tag_list_new', line)
        if mod_num != 0:
            line = mod_line
        ...
        (mod_line, mod_num) = re.subn(r'gst_tag_list_free',
                                      r'gst_tag_list_unref', line)
        if mod_num != 0:
            line = mod_line
...
# a struct containing a buffer alongside caps and some other info).
        m = re.search(
            '(GST_TAG_IMAGE|GST_TAG_PREVIEW_IMAGE|GST_TAG_ATTACHMENT)', line)
        if m != None:
...
# gst_tag_list_get_buffer() => gst_tag_list_get_sample()
        (mod_line, mod_num) = re.subn(r'gst_tag_list_get_buffer',
                                      r'gst_tag_list_get_sample', line)
        if mod_num != 0:
            line = mod_line
...
# gst_is_tag_list() => GST_IS_TAG_LIST ()
        (mod_line, mod_num) = re.subn(r'gst_is_tag_list', r'GST_IS_TAG_LIST',
                                      line)
        if mod_num != 0:
            line = mod_line
...
# gst_registry_get_default() -> gst_registry_get()
        (mod_line, mod_num) = re.subn(r'gst_registry_get_default',
                                      r'gst_registry_get', line)
        if mod_num != 0:
            line = mod_line
        ...
        (mod_line, mod_num) = re.subn(r'gst_default_registry_(.+)\s*\(',
                                      r'gst_registry_\1(gst_registry_get(),',
                                      line)
        if mod_num != 0:
            line = mod_line
...
# GST_VALUE_HOLDS_DATE(value) -> G_VALUE_HOLDS(value,G_TYPE_DATE)
        (mod_line, mod_num) = re.subn(r'GST_VALUE_HOLDS_DATE\s*\((.+)\)',
                                      r'G_VALUE_HOLDS(\1,G_TYPE_DATE)', line)
        if mod_num != 0:
            line = mod_line
        ...
        (mod_line, mod_num) = re.subn(r'gst_value_set_date',
                                      r'g_value_set_boxed', line)
        if mod_num != 0:
            line = mod_line
...
# gst_value_get_date() -> g_value_get_boxed()
        (mod_line, mod_num) = re.subn(r'gst_value_get_date',
                                      r'g_value_get_boxed', line)
        if mod_num != 0:
            line = mod_line
...
# GST_TYPE_G_ERROR / gst_g_error_get_type() -> G_TYPE_ERROR
        (mod_line, mod_num) = re.subn(r'GST_TYPE_G_ERROR', r'G_TYPE_ERROR',
                                      line)
        if mod_num != 0:
            line = mod_line
