...
export CRASHCAR_EVENT_SNR_ARCHIVE_DIR=${CRASHCAR_EVENT_SNR_ARCHIVE_DIR:-"${PWD}/${jobno}/crashcar_candidate_events"}
export CRASHCAR_SNR_SERIES_OUTPUT_DIR=${CRASHCAR_SNR_SERIES_OUTPUT_DIR:-0}
