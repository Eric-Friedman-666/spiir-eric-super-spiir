...
if __name__ == "__main__":
    ...
    zerolags_path = list([f for f in args.data_dir.glob(f"{args.run_name}/*/zerolag_*_*.xml.gz")])[0]
        ...
        with tqdm(
            ...
            for i, file_path in enumerate(file_paths):
                ...
                while True:
                    ...
                    if (int(det_time) == int(time) and float(cohsnr) > args.cohsnr_filter):
                        found = True
                        break
                ...
                cmd = ["bayestar-localize-coincs", str(file_path), str(file_path), "-o", out_path, "--enable-snr-series"]
            ...
            for future in concurrent.futures.as_completed(futures):
                ...
                if len(file_paths) == 0:
                    ...
                    concurrent.futures.wait(subfutures)
